define("gaForDou/1.0.0/src/analysis-debug", ["jquery/1.10.1/jquery-debug"], function(require, exports, module) {
  define(function(require, exports, module) {
    ...
    var track = {
      trackEvent: function() {
        if (arguments.length == 2) _gaq.push(['_trackEvent', arguments[0], arguments[1]]);
        else if (arguments.length == 3) _gaq.push(['_trackEvent', arguments[0], arguments[1], arguments[2]]);
      }
    }
